...
const Navbar = () => {
  ...
  return (
    <nav className="fixed flex py-2 z-50 top-0 items-center justify-between px-4 max-w-6xl w-[90%] mx-auto left-[50%] border-b shadow rounded -translate-x-[50%]  bg-white">
      <Link href={"/"}>
